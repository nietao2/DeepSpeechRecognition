import keras
from tensorflow.python.keras.layers import Input, Conv2D, BatchNormalization, MaxPooling2D
from tensorflow.python.keras.layers import Reshape, Dense, Dropout, Lambda
